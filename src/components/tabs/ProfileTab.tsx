        ...
        <div className="flex items-center gap-4">
          <div className="relative">
            <Avatar className="w-20 h-20 gradient-purple text-4xl">
              {userStats.photo ? (
                <img src={userStats.photo} alt="Профиль" className="object-cover w-full h-full" />
              ) : (
            ...
            <Button
              size="icon"
              className="absolute -bottom-1 -right-1 w-8 h-8 rounded-full gradient-purple"
      ...
      <Tabs defaultValue="achievements" className="w-full">
        ...
        <TabsContent value="achievements" className="space-y-3">
          <Card className="p-8 text-center">
            ...
            <p className="text-muted-foreground">Здесь появятся ваши достижения</p>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="posts" className="space-y-3">
          <Card className="p-8 text-center">
            <div className="text-5xl mb-3">📝</div>
            <p className="text-muted-foreground">Здесь появятся ваши публикации</p>
          </Card>
        </TabsContent>
      ...
      <Dialog open={showSettings} onOpenChange={setShowSettings}>
        <DialogContent className="bg-card">
          ...
          <div className="space-y-4">
            ...
            <Button
              onClick={() => {
                const newData = { nickname, city, avatar, photo: photoURL };
